  ...
  return (
    <section id="home-hero" className="relative h-screen bg-cover bg-center flex items-center justify-center text-white"
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <button onClick={() => setCurrentPage('contact')} className="bg-blue-600 hover:bg-amber-400 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105 animate-fade-in-up delay-400">
          🎉Plan Your Event
        </button>
      </div>
    </section>
