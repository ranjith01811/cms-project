  ...
  return (
    <section id="contact-page-content" className="py-20 px-6 sm:px-10 bg-white min-h-screen pt-24">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-4xl sm:text-5xl font-bold text-red-500 mb-10">Get in Touch With ``BRT Event Management💬</h1>
        <div className="flex flex-col md:flex-row gap-10">
          <div className="md:w-1/2 bg-gray-50 p-8 rounded-xl shadow-md">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-950 hover:bg-orange-500 text-white font-semibold py-3 px-6 rounded-md shadow-md transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-75"
              >
                Send Message
              </button>
            </form>
