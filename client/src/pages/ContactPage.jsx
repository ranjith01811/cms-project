...
const ContactPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch("https://formsubmit.co/ajax/tgbala003@gmail.com", {
        method: "POST",
        headers: {
    ...
    >
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-4xl sm:text-5xl font-bold text-red-500 mb-10">
          Get in Touch With BRT Event Management💬
        </h1>
          ...
          <div className="md:w-1/2 bg-gray-50 p-8 rounded-xl shadow-md">
            ...
            >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full bg-blue-950 text-white font-semibold py-3 px-6 rounded-md shadow-md transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-75 ${
                  isLoading
